...
namespace Chereches_Mara_Lab2.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Chereches_Mara_Lab2Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Chereches_Mara_Lab2Context context,
